...
public class KeyManagerFactoryHelper {
    ...
    private static final String DEFAULT_SERVER_PATH = "cer" + File.separator + "server.jks";
    private static final String DEFAULT_CLIENT_PATH = "cer" + File.separator + "client.jks";
