...
public class UserClaim implements Serializable {
    ...
    public UserClaim(Long userId, String userName, String credit, long lastModifyPasswordTime) {
        this.userId = userId;
        this.userName = userName;
        this.credit = credit;
    ...
    public Map<String, Object> toHeader() {
        ...
        try {
            claimMap.put(CLAIM_USER_NAME, URLEncoder.encode(this.getUserName(), HEADER_CHARSET));
